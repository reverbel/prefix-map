"""Provides general-purpose maps with support to prefix queries.
   ...
   paper][sleator-tarjan] that developed and analysed splay trees. Both
   varieties of splay trees use the same reestructuring heuristic and their
   operations have similar amortized time bounds. 
...
module herd.reverbel.prefixmap "0.0.1" {
